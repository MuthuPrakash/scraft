...
alert("click triggered")
    ...
    render(){
        return(
            ...
            <div onClick={this.onOverView} className='productItem' style={{height:'400px', minWidth: '300px',display:"flex", flexDirection:"column", flex: 1, flexBasis:'calc(33% - 40px)',flexGrow:0, borderWidth:"5px", padding:"15px", margin:"5px", borderColor:"orange"}}>
